...
type HelloResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Gree          string                 `protobuf:"bytes,1,opt,name=gree,proto3" json:"gree,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *HelloResponse) GetGree() string {
	if x != nil {
		return x.Gree
	}
	return ""
...
const file_proto_hello_hello_proto_rawDesc = "" +
	...
	"\x04gree\x18\x01 \x01(\tR\x04gree2E\n" +
	"\n" +
	"HelloProto\x127\n" +
	"\bSayHello\x12\x13.hello.HelloRequest\x1a\x14.hello.HelloResponse\"\x00B9Z7github.com/BirlaPrasoon/my-grpc-proto/protogen/go/hellob\x06proto3"
...
var file_proto_hello_hello_proto_depIdxs = []int32{
	0, // 0: hello.HelloProto.SayHello:input_type -> hello.HelloRequest
	1, // 1: hello.HelloProto.SayHello:output_type -> hello.HelloResponse
